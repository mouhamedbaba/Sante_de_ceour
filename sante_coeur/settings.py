"""
Django settings for sante_coeur project.
...
CKEDITOR_CONFIGS = {
    'default': {
        ...
        'toolbar_Custom': [
            ...
            ['Link', 'Unlink', 'Image', 'UploadImage'],  # Ajoutez 'Image' et 'UploadImage' ici
            ['RemoveFormat', 'Source']
        ],
        'tabSpaces': 4,
...
JAZZMIN_SETTINGS = {
 "site_title": "Mon Interface d'Administration Jazzmin",
}
